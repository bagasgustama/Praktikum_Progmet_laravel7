...
<div class="breadcrumbs">
  <div class="container">
    ...
    <form action="/addpic/upload" method="POST"  enctype="multipart/form-data">
      <div class="">
          <div class="form-group ">
              <input type="file" class="form-control" placeholder="Enter your promocode" name="pilih_foto" required accept="image/*">
          </div>
      </div>
