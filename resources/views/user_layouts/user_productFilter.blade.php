            ...
            <div class="products-right-grids-bottom">
              ...
              <div class="row">
                ...
                {{-- @for ($i=0; $i<2 ; $i++) --}}
                    ...
                    @endforelse
                          {{-- <p><i>Rp.{{ number_format($produkrow->price) }}</i><span class="item_price">Rp.{{ number_format($produkrow->price) }}</span><a class="item_add" style="backgroud-color:red; color:red;" href="#">Buy Now </a><a class="item_add" href="#">add to cart </a></p> --}}
                      </div>
                    </div>
                  {{-- @endfor --}}
              </div>
